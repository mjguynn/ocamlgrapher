...
(** [compute_f_of_x_test name input_equation input_x expected_output
    success] checks if the function of [input_equation] equals
    [expected_output] at [input_x] if [success] is true. If [success] is
    false, it checks that [input_equation] is an invalid equation. *)
